...
//      console.log(course + " - " + year);
    window.location.href = '/feedback'; // redirect the user to the template page
    ...
    return (
        ...
        <div>
            ...
            <h1 id="user-title">WELCOME Dept. Chair!</h1>
        ...
        outlines.map((m) => (
          ...
          <div className="editHistoryTable">
            <table id="history-table">
              <tr>
                <th>Instructor Email</th><th>Course Code</th><th>Time</th><th>Comment</th></tr>
              <td>
                {edits &&
                  edits.map((m) => {
            ...
            <td>
                {edits &&
                  edits.map((m) => {
                    return <tr value={m.newComment} id="course">{m.newComment}</tr>;
                  })}
              </td>
